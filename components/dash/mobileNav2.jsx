...
export default function MobileNav2({menu}) {
  return (
    <Disclosure as="nav" className="">
      <div className="mx-auto max-w-7xl px-2 sm:px-2 lg:px-8 z-10">
        <div className="relative flex h-20 items-center justify-between px-4 w-full">
          ...
          <div className="flex  items-center justify-between  sm:items-stretch w-[90%]">
            ...
            <h4 className='text-text text-lg font-bold'>{menu}</h4>
            </div>
            <div className='flex items-center justify-center'>
